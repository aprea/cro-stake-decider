					...
					<div>
						<Container className="logo-links" fluid>
							...
							<div className="links">
								...
								<a href="https://www.reddit.com/r/Crypto_com/comments/wcnj89/i_made_a_website_to_help_you_decide_what_to_do/">
									<span className="visually-hidden">Reddit thread introducing this website</span>
									<svg className="bi bi-reddit" fill="currentColor" viewBox="0 0 16 16" width="24" xmlns="http://www.w3.org/2000/svg">
